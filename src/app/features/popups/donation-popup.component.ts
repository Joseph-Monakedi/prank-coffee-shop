  ...
  template: `
    <div class="fixed inset-0 bg-black/60 backdrop-blur-xl flex items-center justify-center z-30000">
      <div class="bg-white text-black w-110 p-10 rounded-[28px] text-center shadow-[0_50px_100px_rgba(0,0,0,0.6)] border border-white/20">
        ...
        <p class="text-sm leading-relaxed mb-2 opacity-80">Would you like to add a small R5000 contribution to support our unnamed global initiative? Your generosity makes a difference.</p>
        <p class="text-sm leading-relaxed mb-8 opacity-80">We promise not to buy any Ferraris</p>
